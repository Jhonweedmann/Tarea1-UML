...
public class Main {
    public static void main(String[] args) {
        ...
        //Date para rellenar constructores que lo necesitan
        Date date = new Date();
        ...
        // 2 pagos con efectivo con diferente monto
        Efectivo efectivo = new Efectivo(10000,date);
        Efectivo efectivo2 = new Efectivo(999999,date);


        // Instancia de Boleta y Factura para las instancias de OrdenCompra
        ...
        //Instancia de OrdenCompra que paga con efectivo
        OrdenCompra Pedido1 = new OrdenCompra(d,date,efectivo,Bo);

        //Se agregan más de un DetalleOrden a OrdenCompra
        Pedido1.addDetalleOrden(c);
        Pedido1.addDetalleOrden(f);

        //Se "agrega" dinero a una cuenta en diferentes montos dependiendo de la instancia
        ...
        // Instancias de Tarjeta y Transferencia
        ...
        //Ordenes de compra que pagan con tarjeta o transeferencia,
        ...
        //Direccion para rellenar constructores que lo necesitan
